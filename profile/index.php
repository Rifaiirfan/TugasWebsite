    ...
    <style>
       ...
       .profile-card:hover {
        ...
        .social-buttons {
            ...
            .social-tiktok { 
                background: linear-gradient( #ffe0ea 100%);
            }
            .social-twitter { 
...
<body>
    ...
    <a href="../index.php" class="back-to-login" title="Kembali ke Login">←</a>

    <div class="title-section">
        <h1>PROFIL MAHASISWA </h1>
        <p>Proyek Pemrograman Web dan Database</p>
    </div>

    <div class="container">
        <!-- CARD 1 - KAMU -->
        <div class="profile-card card-1">
            <img src="../assets/img/arsyad.jpeg" alt="Foto Kamu" class="profile-image">
            ...
            <div class="social-section">
                ...
                <div class="social-buttons">
                    ...
                    <a href="https://www.instagram.com/ibadruzzamansp_/" class="social-btn social-instagram" target="_blank" title="Instagram" rel="noopener">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://www.tiktok.com/@priatanfannn" class="social-btn social-tiktok" target="_blank" title="TikTok" rel="noopener">
                        <i class="fab fa-tiktok"></i>
                    </a>
                    <a href="https://twitter.com" class="social-btn social-twitter" target="_blank" title="Twitter" rel="noopener">
        ...
        <div class="profile-card card-2">
            <img src="../assets/img/irfan.jpg" alt="Foto Teman" class="profile-image">
            <div class="profile-header">
                <h2>Irfan</h2>
                <p class="kelas">TE 2C</p>
            </div>
            ...
            <div class="social-section">
                ...
                <div class="social-buttons">
                    ...
                    <a href="https://www.instagram.com/irpanipai_6/" class="social-btn social-instagram" target="_blank" title="Instagram" rel="noopener">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://www.tiktok.com/@ipanipai" class="social-btn social-tiktok" target="_blank" title="TikTok" rel="noopener">
                        <i class="fab fa-tiktok"></i>
                    </a>
                    <a href="https://twitter.com" class="social-btn social-twitter" target="_blank" title="Twitter" rel="noopener">
                        <i class="fab fa-twitter"></i>
